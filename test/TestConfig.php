...
class TestConfig
{
    ...
    /**
      * $apiClient
      * @var DocuSign\Click\Client\ApiClient
      */
    protected $apiClient;
    ...
    {
        $this->host = !empty($host) ? $host : 'https://demo.docusign.net/clickapi';
    ...
    /**
     * Gets apiClient
     * @return DocuSign\Click\Client\ApiClient
     */
    ...
    /**
     * Sets apiClient
     * @param DocuSign\Click\Client\ApiClient $apiClient
     * @return $this
     */
